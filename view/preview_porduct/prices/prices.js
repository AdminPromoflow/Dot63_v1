...
export class PricesController {
  ...
  updateSummary() {
    ...
    this.setText(this.elements.extraQuantity, hasPrice && extrasPerUnit > 0 ? safeQuantity.toLocaleString("en-GB") : "—");
    ...
    this.setText(this.elements.unitHint, hasPrice ? `per unit at ${safeQuantity.toLocaleString("en-GB")} units` : "Pricing not configured");
  }
