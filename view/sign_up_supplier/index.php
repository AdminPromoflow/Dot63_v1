...
<head>
  ...
  <link rel="stylesheet" href="../../view/sign_up_supplier/style.css?v=<?php echo filemtime("../../view/sign_up_supplier/style.css"); ?>">
</head>
...
<body class="body_sigUp_Supplier">
  ...
  <?php include "../../view/global/supplier_auth/supplier_auth.php"; ?>
</body>
</html>
