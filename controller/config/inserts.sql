...
JOIN (
  ...
  UNION ALL SELECT 'Lanyards', 'Unassigned Group'
  ...
  UNION ALL SELECT 'Lanyards', 'Lanyards - SuperLanyard'
  UNION ALL SELECT 'Lanyards', 'Lanyards - Double-Ended'
  UNION ALL SELECT 'Lanyards', 'Lanyards - Rigid Card Holder'
  UNION ALL SELECT 'Lanyards', 'Lanyards - Plastic Wallet'
  UNION ALL SELECT 'Lanyards', 'Lanyards - Retractable Reel'
  UNION ALL SELECT 'Lanyards', 'Lanyards - Cord Lock'
...
JOIN (
  ...
  UNION ALL SELECT 'Lanyards', 'Price'
  UNION ALL SELECT 'Lanyards', 'Colour'
  UNION ALL SELECT 'Lanyards', 'Print technique'
  UNION ALL SELECT 'Lanyards', 'Material'
  UNION ALL SELECT 'Lanyards', 'Environmental certifications'
  UNION ALL SELECT 'Lanyards', 'Social audit'
  UNION ALL SELECT 'Lanyards', 'Impact Index'
  UNION ALL SELECT 'Lanyards', 'Brand'
  UNION ALL SELECT 'Lanyards', 'Theme'
  UNION ALL SELECT 'Lanyards', 'Stock location'
  UNION ALL SELECT 'Lanyards', 'Bluetooth'
  UNION ALL SELECT 'Lanyards', 'Printed sides'
  UNION ALL SELECT 'Lanyards', 'Width'
