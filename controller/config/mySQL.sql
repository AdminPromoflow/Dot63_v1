...
/*  Created On : 11-Jan-2026 9:17:41 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE `type_variations`
 ADD INDEX `IXFK_type_variations_categories_02` (`category_id` ASC)
;
...
ALTER TABLE `type_variations`
 ADD CONSTRAINT `FK_type_variations_categories_02`
	FOREIGN KEY (`category_id`) REFERENCES  () ON DELETE Restrict ON UPDATE Restrict
;
