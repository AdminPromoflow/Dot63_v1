...
/*  Created On : 08-Apr-2026 7:26:05 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	`status` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 Draft, 1 Published, 2 Configurable product, 3 Separate combinations',
	`pending_status` TINYINT UNSIGNED NULL,
	`status_request_version` INT UNSIGNED NOT NULL DEFAULT 0,
...
(
	...
	`price_display_mode` VARCHAR(50) NULL,
	`parent_id` INT NULL,
	`product_id` INT NULL,
	`type_id` INT NULL,
